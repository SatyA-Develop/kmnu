            ...
            <div class="legal-wrap">
                ...
                while ( have_posts() ) :
                    ...
                    if (empty(get_the_content())) {
                        ...
                        echo "<p>Your privacy is important to us. It is KMNU Hospital's policy to respect your privacy regarding any information we may collect from you across our website.</p>";
                        echo "<p>We only ask for personal information when we truly need it to provide a service to you. We collect it by fair and lawful means, with your knowledge and consent. We also let you know why we’re collecting it and how it will be used.</p>";
                    } else {
                        the_content();
                    }
                endwhile;
